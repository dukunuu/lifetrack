  ...
  return (
    <div class="flex-1 p-6 lg:p-8">
      <div class="mx-auto max-w-7xl">
        <div class="glass-card mb-8 flex flex-wrap items-center justify-between gap-4 rounded-2xl px-5 py-4">
          <div>
              ...
              <div class="grid gap-4 md:grid-cols-2">
                ...
                <label class="form-control w-full">
                  ...
                  <div class="flex gap-2">
                    <input
                      class="input input-bordered glass-input flex-1"
          ...
          <section class="glass-card rounded-2xl p-6 shadow-sm">
            ...
            <div class="space-y-5">
              ...
              <label class="form-control w-full">
                ...
                <select
                  class="select select-bordered glass-input w-full"
        ...
        <Show when={helpSection()}>
          <div class="modal modal-open backdrop-blur-sm">
            <div class="modal-box glass-card-raised relative w-full max-w-2xl">
              <button
                type="button"
              ...
              <Show when={helpSection() === 'sync'}>
                <div class="space-y-4">
                  ...
                  <ol class="text-base-content/80 list-decimal space-y-2 pl-5 text-sm">
                    <li>
                      Deploy a CouchDB instance reachable from the browser (HTTPS recommended).
                    </li>
