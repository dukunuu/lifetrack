              ...
              return (
                <div class="card bg-base-200 border-base-300 border shadow-md transition-shadow hover:shadow-lg">
                  <div class="card-body space-y-4 p-6">
                    {/* Header with actions */}
                    <div class="flex items-center justify-between">
                      <span class="badge badge-primary badge-lg max-w-36 gap-2 text-sm sm:text-base">
                        <span class="hidden font-semibold text-nowrap">Field {index + 1}·</span>
                        {field().label && <span class="truncate opacity-80"> {field().label}</span>}
                      </span>
